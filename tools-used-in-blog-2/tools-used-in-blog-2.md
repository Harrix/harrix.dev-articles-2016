...
- [Добавление своих шорткодов](#добавление-своих-шорткодов)
- [Отображение файлов Markdown \*.md в WordPress](#отображение-файлов-markdown-md-в-wordpress)
- [Оформление цитат](#оформление-цитат)
- [Видео на сайте](#видео-на-сайте)
- [Для отображения содержимого документов](#для-отображения-содержимого-документов)
- [Lightbox](#lightbox)
- [Комментарии](#комментарии)
- [Аналитика](#аналитика)
- [Выделение слов](#выделение-слов)
- [Кнопки «Скачать», «Демо», «Исходники»](#кнопки-скачать-демо-исходники)
- [Запрет обрамления картинок в тэг p](#запрет-обрамления-картинок-в-тэг-p)
- [Добавления класса картинкам в статье](#добавления-класса-картинкам-в-статье)
- [Favicon сайта](#favicon-сайта)
- [Цвет вкладки на смартфонах в Chrome](#цвет-вкладки-на-смартфонах-в-chrome)
- [Добавление еще одного файла CSS в теме](#добавление-еще-одного-файла-css-в-теме)
- [Отключаем смайлики](#отключаем-смайлики)
- [Удаление стилей от плагина YARPP](#удаление-стилей-от-плагина-yarpp)
- [Добавления шорткода raw](#добавления-шорткода-raw)
- [Добавление поиска в меню](#добавление-поиска-в-меню)
- [Автоматическая публикация RSS в Twitter](#автоматическая-публикация-rss-в-twitter)
...
Читайте в [статье](https://github.com/Harrix/harrix.dev-articles-2014/blob/main/show-pdf-from-github/show-pdf-from-github.md) | [↗️](https://harrix.dev/ru/articles/2014/show-pdf-from-github/).
