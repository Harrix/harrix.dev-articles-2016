...
Статья по содержанию совпадает со статьей [Интерпретатор функции в Qt — QtScript](https://github.com/Harrix/harrix.dev-blog-2014/blob/main/2014-05-19-qtscript/2014-05-19-qtscript.md), где рассказывается про QtScript.
