...
Первым продвинутым блокнотом, которым я начал активно пользоваться, был [Notepad++](https://github.com/Harrix/harrix.dev-articles-2013/blob/main/faq-notepad-plus-plus/faq-notepad-plus-plus.md) | [↗️](https://harrix.dev/ru/articles/2013/faq-notepad-plus-plus/) (до сих пор им часто пользуюсь), потом пытался перейти на [Sublime Text](https://github.com/Harrix/harrix.dev-articles-2013/blob/main/faq-sublime-text-2/faq-sublime-text-2.md) | [↗️](https://harrix.dev/ru/articles/2013/faq-sublime-text-2/). А потом пробовал перейти на Atom, про который говорится в этой статье.
