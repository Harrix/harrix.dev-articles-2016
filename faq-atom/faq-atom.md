...
Первым продвинутым блокнотом, которым я начал активно пользоваться, был [Notepad++](https://github.com/Harrix/harrix.dev-blog-2013/blob/main/2013-03-03-faq-notepad-plus-plus/2013-03-03-faq-notepad-plus-plus.md) (до сих пор им часто пользуюсь), потом пытался перейти на [Sublime Text](https://github.com/Harrix/harrix.dev-blog-2013/blob/main/2013-01-05-faq-sublime-text-2/2013-01-05-faq-sublime-text-2.md). А потом пробовал перейти на Atom, про который говорится в этой статье.
